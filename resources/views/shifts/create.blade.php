...
@section('main-content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">إضافة شيفت جديد</h1>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="card-body text-right">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" min="0" name="starting_cash" id="starting_cash"
                                           class="form-control" value="{{ old('starting_cash', 0) }}" required>
                                </div>

                                <div class="form-group">
                                    <label for="expected_cash">الكاش المتوقع</label>
                                    <input type="number" step="0.01" min="0" name="expected_cash" id="expected_cash"
                                           class="form-control" value="{{ old('expected_cash', 0) }}">
                                </div>

                                <div class="form-group">
                                    <label for="ending_cash">رصيد النهاية</label>
                                    <input type="number" step="0.01" min="0" name="ending_cash" id="ending_cash"
                                           class="form-control" value="{{ old('ending_cash') }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control" required>
                                        ...
                                        <option value="paused" {{ old('status') == 'paused' ? 'selected' : '' }}>موقوف</option>
