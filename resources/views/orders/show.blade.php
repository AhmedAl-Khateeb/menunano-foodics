    ...
    <div class="card shadow-lg rounded-lg">
        <div class="card-header bg-gradient-primary text-white d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            @if($order->status != 'served')
                <x-model name="serve-{{ $order->id }}" status="success" icon="fa fa-check" title="تأكيد التوصيل" message="هل تم توصيل هذا الطلب؟">
        ...
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-md-4">
                    <p><strong>الاسم:</strong> <span class="text-primary font-weight-bold">{{ $order->name }}</span></p>
                </div>
                <div class="col-md-4">
