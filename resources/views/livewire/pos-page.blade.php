                    ...
                    <div class="flex gap-2 items-center">
                        ...
                        @if (!empty($cart))
                            <button wire:click="openResetModal"
                                class="text-red-400 hover:text-red-200 transition-colors mx-1" title="تفريغ الفاتورة">
                ...
                <div class="p-4">
                    @if (empty($cart))
                        <div class="flex flex-col items-center justify-center h-full text-gray-400 opacity-60">
                            ...
                            <button
                                class="mt-4 px-6 py-2 bg-blue-600 text-white rounded-lg font-bold hover:bg-blue-700 transition"
                                wire:click="setTab('products')">
                                الذهاب للمنتجات
                            </button>
                        </div>
                    ...
                    <div
                        ...
                        <div class="mb-4 bg-gray-50 p-3 rounded-xl border border-gray-200">
                            ...
                            <div class="grid grid-cols-4 gap-2">
                                ...
                                <button wire:click="$set('orderType', 'table')"
                                ...
                                <button wire:click="$set('orderType', 'free_seating')"
                        ...
                        @if ($orderType === 'delivery')
                            <div class="mb-4 bg-orange-50 p-3 rounded-xl border border-orange-100 animate-fade-in">
                                ...
                                <div class="grid grid-cols-2 gap-3 mb-3">
                                    ...
                                    <div>
                                        <label class="text-[10px] text-orange-600 font-bold mb-1 block">رسوم التوصيل
                            ...
                            <div class="grid grid-cols-2 gap-3" x-data="{ showNameInput: false }">
                                ...
                                <div class="col-span-1 flex items-end">
                                    ...
                                    @elseif(strlen($customerPhone) > 3)
                                        ...
                                        <div class="w-full" x-show="showNameInput || '$wire.customerName' != ''">
                                            <label class="text-[10px] text-blue-500 font-bold mb-1 block">اسم العميل
                                                الجديد</label>
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <button
                                        ...
                                        <div class="flex items-center gap-2"><i class="fas fa-money-bill-wave"></i>
                                            نقدي</div>
                                        <span
                                            class="text-[10px] {{ $paymentMethod === 'cash' ? 'bg-white/20' : 'bg-gray-100 text-gray-500' }} px-2 rounded-full">المطلوب:
                                    ...
                                    @foreach ($paymentMethods as $method)
                                        <button
                                            ...
                                            <div class="flex items-center gap-2"><i class="fas fa-wallet"></i>
                                                {{ $method->name }}</div>
                                            @if ($method->phone)
                                                <span
                                                    class="text-[10px] opacity-80 font-mono tracking-wider">{{ $method->phone }}</span>
                                            @endif
                                        </button>
                                    @endforeach
                                </div>
                            ...
                            @php
                                ...
                                $btnDisabled =
                                    !$isDraft && $paymentMethod === 'cash' && $paidAmount < $total ? 'disabled' : '';
                            @endphp
                            <button
            ...
            <div
                ...
                <div class="relative bg-gray-100 h-48 w-full">
                    ...
                    <div class="absolute bottom-4 right-4 text-white z-10 w-full px-4">
                        <h3 class="font-bold text-2xl shadow-sm truncate">{{ $this->selectedProductForSize->name }}
                        </h3>
                    </div>
                </div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-opacity animate-fade-in"
            ...
            <div
                ...
                <div class="p-6 text-center">
                    ...
                    <p class="text-gray-500 mb-6">هل أنت متأكد من حذف جميع المنتجات من السلة؟ لا يمكن التراجع عن هذا
                        الإجراء.</p>
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:mr-4 sm:text-right">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        هل أنت متأكد من رغبتك في حذف جميع العناصر من الفاتورة؟ لا يمكن التراجع عن هذا
                                        الإجراء.
                                    </p>
                                </div>
                            </div>
                ...
                <div class="p-4 overflow-y-auto flex-1 bg-gray-50 flex flex-col gap-3 custom-scrollbar">
                    ...
                    @empty
                        <div class="flex flex-col items-center justify-center py-10 text-gray-400">
                            ...
                            <p class="mt-2 text-sm text-center max-w-xs text-gray-400">جميع طاولات الصالة وطلبات الجلوس
