...
@section('main-content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">تعديل نوع النشاط</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="{{ route('business-types.update', $businessType->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body text-right">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="أدخل اسم نوع النشاط" value="{{ old('name', $businessType->name) }}"
                                        required>
                                </div>
