                                                    ...
                                                    <form action="{{ route('products.update', $product->id) }}"
                                                        ...
                                                        <div class="modal-body text-dark">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    <label
                                                                        for="description-{{ $product->id }}">الوصف</label>
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    <label
                                                                        for="category_id-{{ $product->id }}">الفئة</label>
...
@error('price') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="price-{{ $product->id }}">سعر
                                                                        الشراء</label>
                                                                    <input type="number"
                                                                ...
                                                                ِ <div class="col-md-6 mb-3">
                                                                    <label for="cover-{{ $product->id }}">الصورة (اتركها
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-secondary btn-sm mt-2 add-size-btn"
                                                                data-target="#sizes-wrapper-{{ $product->id }}">+ إضافة
                                                                حجم آخر</button>
                                                        </div>
                                                        <div class="modal-footer border-0 justify-content-between">
                                                            <button type="button" class="btn btn-outline-secondary px-4"
                                        ...
                                        {{-- زر الحذف --}}
                                        <x-model name="delete-{{ $product->id }}" status="danger" icon="fa fa-trash"
                                            title="حذف" message="هل أنت متأكد من حذف {{ $product->name }}؟">
                                        ...
                                        <a href="{{ route('products.show', $product->id) }}"
                                            class="btn btn-outline-info btn-sm ml-1 mb-1">
