...
@section('main-content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">أحتساب مرتبات </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">الرئيسية</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('staff.create') }}">مرتب موظف </a></li>
                        <li class="breadcrumb-item active">مرتب </li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                ...
                <form action="{{ route('staff.store') }}?staff_id={{ $staff->id }}" method="POST"
                    ...
                    <div class="form-group mb-3 text-right">
                        ...
                        <input type="date" name="BirthDay" step="0.01" min="0" max="100"
                            class="form-control  text-right" id="name" placeholder="أدخل اسم الموظف" value=""
                            required="">
                    </div>
                    ...
                    <div class="form-group mb-3 text-right">
                        ...
                        <input type="datetime-local" name="Start_date" step="0.01" min="0" max="100"
                            class="form-control  text-right" id="commission_percent" placeholder="أدخل نسبة العمولة"
                            value="0">
                    ...
                    <div class="form-group mb-3 text-right">
                        ...
                        <input type="datetime-local" name="End_date" step="0.01" min="0" max="100"
                            class="form-control  text-right" id="commission_percent" placeholder="أدخل نسبة العمولة"
                            value="0">
