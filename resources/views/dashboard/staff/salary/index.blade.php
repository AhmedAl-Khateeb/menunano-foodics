                    ...
                    <div class="card border-0 shadow-sm rounded-lg">
                        <div
                            ...
                            <a href="{{ route('staff.create') }}" class="btn btn-primary btn-sm ms-auto shadow-sm"
                                data-toggle="modal" data-target="#desc-add">
                        ...
                        <div class="modal fade" id="desc-add" tabindex="-1" aria-labelledby="descAddLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content rounded-lg shadow">

                                    <form action="{{ route('salary_m.store') }}" method="POST"
                                        ...
                                        <input type="hidden" name="_token"
                                            value="zuPPPMo09ckMkKbY8mvcAePvb4bwnCf2wrz1BuQ2" autocomplete="off">
                                        ...
                                        <div class="modal-body text-dark">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="Rewards" id="Rewards" class="form-control "
                                                    value="" required autofocus>
                                            </div>

                                            @foreach ($salary as $staff_salary)
                                                <div class="form-group">
                                                    <input name="staff_id" id="staff_id" class="form-control"
                                                        type="hidden" value="{{ $staff_salary->staff->id }}" required
                                                        autofocus>
                                                </div>
                                    ...
                                    @forelse ($salary as $staff_salary)
                                        <tr>
                                            ...
                                            <td class="text-center font-weight-bold">
                                                {{ number_format($staff_salary->staff->Salary, 2) }} ج.م</td>


                                            <td class="font-weight-bold text-dark">{{ $staff_salary->penalties }}</td>

                                            <td class="font-weight-bold text-dark">{{ $staff_salary->Salary_advance }}
                                            </td>
                                            ...
                                            <td class="text-center text-muted" dir="ltr">
                                                {{ number_format($staff_salary->staff->Salary + $staff_salary->Rewards - ($staff_salary->penalties + $staff_salary->Salary_advance)) }}
                                                ج.م </td>
