            ...
            <div class="card card-primary">
                ...
                <form action="{{ route('expenses.store') }}"    method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3 text-right">
                            ...
                            <input type="text" name="expanse_name" class="form-control " id="name" placeholder="أدخل اسم المصروف" value="" required="">
                                                            </div>
        ...
        <div class="form-group mb-3 text-right">
            ...
            <input type="file" name="upload"  class="form-control  text-right" id="attach_File" placeholder='أرفاق ملف' value="">
                        ...
                        <div class="form-group mb-3 text-right">
                            ...
                            <input type="text" name="Amount" class="form-control  text-right" id="Amount" placeholder="أدخل أجمالي المبلغ" value="">
                                                            </div>
