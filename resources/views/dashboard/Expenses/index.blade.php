                                        ...
                                        @forelse ($expenses as $expense)
                                            <tr>
                                                ...
                                                <td class="font-weight-bold text-dark">
                                                    ...
                                                    <a href="Attachfile/Expenses/{{ $expense->attach_File }}"
                                                ...
                                                <td class="text-center text-muted" dir="ltr">
                                                    {{ $expense->created_at->format('Y-m-d') }}</td>
                                                <td class="text-center font-weight-bold">
                                                    {{ number_format($expense->Amount, 2) }} ج.م</td>
                                                    ...
                                                    <div class="d-flex gap-2 justify-content-center">
                                                        ...
                                                        <form action="{{ route('expenses.destroy', $expense->id) }}"
                                                            ...
                                                            <button type="submit"
                                                                ...
                                                                onclick="return confirm('هل أنت متأكد من حذف سجل مصروفات  هذا؟')"
                                                                title="حذف المصروفات">
