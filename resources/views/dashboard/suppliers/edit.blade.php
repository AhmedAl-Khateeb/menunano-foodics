...
@section('main-content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">تعديل بيانات مورد</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-8 mx-auto">
                    <div class="card card-primary border-0 shadow-sm rounded-lg">
                        <div class="card-header bg-white border-bottom text-right">
                            <h3 class="card-title font-weight-bold text-dark mb-0 py-1 float-right">تحديث بيانات المورد: <span class="text-primary">{{ $supplier->name }}</span></h3>
                        </div>
                        <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST">
                            ...
                            <div class="card-body bg-light text-right">
                                <div class="row">
                                    <div class="col-md-12 form-group mb-3 text-right">
                                        ...
                                        <input type="text" name="name" class="form-control bg-white @error('name') is-invalid @enderror" id="name" placeholder="أدخل اسم المورد أو الشركة" value="{{ old('name', $supplier->name) }}" required>
                                    ...
                                    <div class="col-md-6 form-group mb-3 text-right">
                                        ...
                                        <input type="text" name="phone" class="form-control bg-white @error('phone') is-invalid @enderror" id="phone" placeholder="أدخل رقم الهاتف" value="{{ old('phone', $supplier->phone) }}">
                                    ...
                                    <div class="col-md-6 form-group mb-3 text-right">
                                        ...
                                        <input type="email" name="email" class="form-control bg-white @error('email') is-invalid @enderror" id="email" placeholder="example@email.com" value="{{ old('email', $supplier->email) }}">
                                    ...
                                    <div class="col-md-12 form-group mb-3 text-right">
                                        ...
                                        <textarea name="address" class="form-control bg-white @error('address') is-invalid @enderror" id="address" rows="2" placeholder="أدخل عنوان المورد">{{ old('address', $supplier->address) }}</textarea>
                                        @error('address') <span class="text-danger small font-weight-bold">{{ $message }}</span> @enderror
                                    </div>

                                    <div class="col-md-12 form-group mb-3 text-right">
                                        <label label="balance" class="font-weight-bold">الرصيد (ج.م)</label>
                                        <div class="input-group">
                                            <input type="number" step="0.01" name="balance" class="form-control bg-white @error('balance') is-invalid @enderror text-right" id="balance" placeholder="0.00" value="{{ old('balance', $supplier->balance) }}">
                                    ...
                                    <div class="col-md-12 form-group mb-0 mt-2 text-right">
                                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                            <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" {{ old('is_active', $supplier->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="card-footer bg-white border-top text-right py-3">
                                ...
                                <button type="submit" class="btn btn-primary font-weight-bold px-4 shadow-sm"><i class="fas fa-save mr-1"></i> حفظ التعديلات</button>
                            </div>
                        </form>
                    </div>
                </div>
