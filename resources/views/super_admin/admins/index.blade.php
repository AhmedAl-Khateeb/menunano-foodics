                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0">{{ $admins->where('status', 1)->count() }}</h2>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0">{{ $admins->where('status', 0)->count() }}</h2>
                        </div>
                                ...
                                @forelse($admins as $index => $admin)
                                    <tr class="align-middle">
                                        <td class="text-center fw-bold">
                                            <span class="badge badge-light">{{ $index + 1 + ($admins->currentPage() - 1) * $admins->perPage() }}</span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('admins.toggleStatus', $admin->id) }}" method="POST">
                                                ...
                                                <div class="form-switch d-flex justify-content-center align-items-center">
                                                    ...
                                                    <label class="switch-slider me-2" for="switch-{{ $admin->id }}"></label>
                    ...
                    <div class="card-footer bg-light">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="text-muted small">
                                عرض {{ $admins->firstItem() ?? 0 }} إلى {{ $admins->lastItem() ?? 0 }} من إجمالي {{ $admins->total() }} نتيجة
                            </div>
                            <div>
                                {{ $admins->links() }}
                            </div>
