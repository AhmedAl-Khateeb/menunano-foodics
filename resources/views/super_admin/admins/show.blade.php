                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center mb-4">
                            <div class="avatar-wrapper position-relative d-inline-block">
                                @if ($admin->image)
                                    <img src="{{ asset('storage/' . $admin->image) }}" alt="صورة المدير"
                                        class="rounded-circle shadow-sm border border-4 border-white" width="140"
                            ...
                            <div class="mt-2">
                                <span
                                    class="badge bg-{{ $admin->status == 1 ? 'success' : 'danger' }} rounded-pill px-3 py-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                            ...
                                            @if ($admin->store_name)
                                                ...
                                                <div class="mt-2 d-flex align-items-center">
                                                    ...
                                                    <button class="btn btn-sm btn-outline-secondary copy-link"
                                                        data-url="{{ $storeUrl }}" title="نسخ الرابط">
                                ...
                                <div class="info-card mb-3 p-3 bg-light rounded-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <strong
                                                class="text-dark">{{ optional($admin->package)->name ?? 'بدون' }}</strong>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="info-card mb-3 p-3 bg-light rounded-3">
                                    <div class="d-flex align-items-center mb-2">
                                        <div
                                            class="icon-wrapper {{ $admin->status == 1 ? 'bg-success' : 'bg-danger' }} rounded-circle p-2 me-3">
                        ...
                        @if ($admin->subscription_start || $admin->subscription_end)
                            <div class="row mt-4">
                                        ...
                                        <div class="info-card mb-3 p-3 bg-light rounded-3">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <small
                                                        class="text-{{ $isExpired ? 'danger' : 'muted' }} d-block mt-1">
                                                        @if ($isExpired)
                                ...
                                @if ($admin->subscription_start && $admin->subscription_end)
                                    <div class="col-12">
                                        <div
                                            class="alert alert-{{ \Carbon\Carbon::parse($admin->subscription_end)->isPast() ? 'danger' : 'success' }} rounded-3 d-flex align-items-center">
                                            @php
                                                $subscriptionEnd = \Carbon\Carbon::parse($admin->subscription_end);
                                                $isExpired = $subscriptionEnd->isPast();
                                            @endphp
                                            <i
                                                class="fas {{ $isExpired ? 'fa-times-circle' : 'fa-check-circle' }} me-2"></i>
                                            <div>
                                                <strong>
                        ...
                        <div class="d-flex gap-2 justify-content-center mt-4 pt-3 border-top">
                            <a href="{{ route('admins.edit', $admin->id) }}" class="btn btn-primary px-4">
