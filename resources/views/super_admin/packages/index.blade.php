                            ...
                            <div class="package-details mb-4">
                                <div class="detail-item mb-3 p-3 bg-light rounded-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <small class="text-muted d-block mb-1">السعر</small>
                                            <span class="fw-bold text-dark fs-5">{{ number_format($package->price, 0) }}
                                                ج.م</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="detail-item mb-3 p-3 bg-light rounded-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-bold text-dark">{{ $package->duration }} يوم</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="detail-item p-3 bg-light rounded-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1">
                                            <small class="text-muted d-block mb-2">المميزات</small>
                                            <ul class="list-unstyled mb-0 features-list">
                                                @foreach($package->features as $feature)
                                                    <li class="d-flex align-items-center mb-1">
                                                        ...
                                                        <span class="text-dark">{{ $feature->text }}</span>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4">
                        <div class="stat-item">
                            <h4 class="text-success mb-1">{{ $packages->where('is_active', true)->count() }}</h4>
                            <small class="text-muted">باقات مفعلة</small>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="stat-item">
                            <h4 class="text-secondary mb-1">{{ $packages->where('is_active', false)->count() }}</h4>
