                ...
                <tbody>
                    @forelse($sections as $i => $s)
                        <tr class="text-center">
                            ...
                            <td>
                                @if($s->image)
                                    <img src="{{ asset('storage/app/public/'.$s->image) }}" alt="image" width="80">
                                @else
                                    —
                                @endif
                            </td>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('sections.edit', $s->id) }}" class="btn btn-outline-primary btn-sm">
                    ...
                    @empty
                        <tr><td colspan="5" class="text-center p-4">لا توجد أقسام</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
